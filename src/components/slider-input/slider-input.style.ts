...
export default css`
  ...
  @layer nuraly.components {
    ...
    nr-slider-input[disabled] .range-slider {
    ...
    nr-slider-input[disabled] .range-slider-value {
      background: var(--nuraly-slider-input-local-disabled-color);
    }

    nr-slider-input[disabled] .range-thumb {
    ...
    nr-slider-input[disabled] input {
      cursor: not-allowed;
    }

    /* Size variants */
    nr-slider-input[size="small"] {
